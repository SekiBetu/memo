...
```shell
sudo ./debi.sh --full-upgrade --firmware --version 11 --architecture amd64 --full-upgrade --dns '8.8.8.8 8.8.4.4' --hostname debian --authorized-keys-url https://github.com/SekiBetu.keys --timezone Asia/Shanghai --user sekibetu --password <新系统用户密码> --ssh-port <SSH端口>
```
