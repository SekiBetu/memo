...
screen -S "B1" -X stuff "\n"
echo "进入目录"
screen -S "B1" -X stuff "php8.1 index.php user1.ini"
screen -S "B1" -X stuff "\n"
echo "用户1部署完毕"
...
screen -S "B2" -X stuff "\n"
echo "进入目录"
screen -S "B2" -X stuff "php8.1 index.php user2.ini"
screen -S "B2" -X stuff "\n"
echo "用户2部署完毕"
echo "=============================================================="
...
screen -S "L" -X stuff "\n"
echo "佐藤希Youtube"
screen -S "L" -X stuff "nohup record/record_new.sh bilibili 24893910 -o record_video/yuefu -u baidupcs3:45468736:record_video/yuefu -dt all &"
screen -S "L" -X stuff "\n"
screen -S "L" -X stuff "\n"
echo "乐府Bilibili"
