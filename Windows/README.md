...
- [WPS](https://www.wps.cn/) 配置里关闭在线资源和功能推荐
...
- [ImageGlass](https://github.com/d2phap/ImageGlass/releases)、[XnViewMP](https://www.xnview.com/en/xnviewmp/)、[NeeView](https://github.com/neelabo/NeeView/releases)
...
- [Temurin](https://adoptium.net/zh-CN/temurin/releases/?os=windows&arch=x64&package=jdk&version=21)
...
- [SolidWorks](https://www.423down.com/16519.html)、[RealViewOn](https://github.com/ianalexis/Real-View-On-Releases/releases)、[Autodesk Fusion](https://www.autodesk.com/products/fusion-360/personal-form?userstate=signedin)、[direct link](https://dl.appstreaming.autodesk.com/production/installers/Fusion%20Client%20Downloader.exe)、[direct link2](https://www.autodesk.com/products/fusion-360/appstream)、[续签](https://www.autodesk.com/campaigns/fusion-360/5-reasons-why?term=1-YEAR&tab=subscription)
